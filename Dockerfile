...
CMD YESOD_HOST=0.0.0.0 YESOD_PORT=8080 YESOD_SQLITE_DATABASE="/data/wordify-webapp-v2.sqlite3" SESSION_BACKEND_CERTIFICATE_DIRECTORY="/data" ./bin/wordify-webapp
